...
// macro
#define RX_QUEUE_SIZE			   	(64*256)
#define TX_QUEUE_SIZE				(64*256)
...
DMPAPI(void) usb_SetTimeOut(void *vusb, DWORD timeout)
{
	USB_Device *usb = (USB_Device *)vusb;
	if (usb == NULL) { err_print((char*)"%s: USB device is null.\n", __FUNCTION__); return; }
	usb->TimeOut = timeout;
